import os
os.environ['CUDA_VISIBLE_DEVICES'] = "MIG-GPU-8ab9a0c8-909c-3f13-97e6-7376d6d4a029/7/0"
...
model_parms = {"encoder_name":encoder,
                ...
                "classes":out_class,
                "activation":None}
checkpoint = "checkpoint/CARLA_GEN_SEMANTIC_SEGMENTATION_efficientnet-b6(ENCODER)_UNet(DECODER)"
